...
// {word}, {category}, {rule}, {question}, and {dare} are filled by the app with
// concrete content so players are handed a task, never asked to invent one.
...
export const cardRules = {
  A: {
    ...
    2: 'Waterfall! Then a new rule for the round: {rule}.',
    3: 'Waterfall! Last one still drinking takes a dare: {dare}',
  },
  2: {
    title: 'You',
  ...
  3: {
    ...
    3: 'You drink and answer this: {question}',
  },
  4: {
    title: 'Floor',
    1: 'Last person to touch the floor drinks.',
    2: 'Last person to hit the floor drinks twice.',
    3: 'Last person to hit the floor takes a dare: {dare}',
  },
  5: {
    title: 'Guys',
  ...
  7: {
    ...
    3: 'Last person to raise a hand takes a dare: {dare}',
  },
  8: {
    title: 'Mate',
  ...
  9: {
    title: 'Rhyme',
    1: 'Rhyme with “{word}” — go around; first to fail drinks.',
    2: 'Rhyme with “{word}” — first to fail drinks twice.',
    3: 'Rhyme with “{word}” — first to fail takes a dare: {dare}',
  },
  10: {
    title: 'Categories',
  ...
  J: {
    ...
    3: 'Thumb Master — the slowest each time takes a sip; third time, a dare: {dare}',
  },
  Q: {
    title: 'Question Master',
    1: 'Anyone who answers your questions drinks — until the next Queen.',
    2: 'Question Master — trip people up until the next Queen.',
    3: 'Question Master — anyone who answers takes a dare: {dare}',
  },
  K: {
    title: 'King’s Cup',
    ...
    3: 'Pour into the cup. 4th King drinks it — then takes a dare: {dare}',
  },
}
